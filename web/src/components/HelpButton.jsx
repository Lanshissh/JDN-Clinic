...
const TOURS = {
  ...
  "/employees": [
    { target: "employees-add-btn", title: "Add an Employee",    body: "Click here to add a new employee to the master list. Fill in their name, B.U. / Company, department, designation, and birthday." },
  ...
  "/first-aiders": [
    { target: "first-aiders-add-btn", title: "Add a First Aider", body: "Click here to add a trained first aider with company, training dates, remarks, and assigned location." },
    { target: "first-aiders-filters", title: "Filter Records", body: "Search by name, company, location, or remarks. Use the dropdowns to focus on expired training, resigned, or a specific location." },
    { target: "first-aiders-table", title: "First Aider Report", body: "This table follows the manual report columns. Use Export Excel to download the current filtered list." },
  ],
  "/employees/:id": [
...
const GUIDE_TOPICS = [
  ...
  { id: "first-aiders", icon: "FA", title: "First Aiders",      steps: [{ title: "Add First Aider", body: "Click Add First Aider and enter name, company, training start/end dates, remarks, and assigned location." }, { title: "Filter", body: "Use Search, Remarks, and Assigned Location filters to find the exact list you need." }, { title: "Export", body: "Export Excel downloads the current filtered report using the manual report columns." }] },
  { id: "employees",  icon: "👥", title: "Employees",         steps: [{ title: "Add Employee", body: "Click Add Employee and fill in name, B.U. / Company, department, designation, and birthday." }, { title: "Open history", body: "Click any employee row to see all their BP, checkup, and inpatient records." }] },
